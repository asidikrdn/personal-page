    ...
    sertifikasi: [
      {
        ...
        tautan:
          "https://certified.niomic.com/?number=00019110006/NIOMIC/IX/2022",
      ...
      },
      {
        ...
        tautan:
          "https://certified.niomic.com/?number=00018310005/NIOMIC/IX/2022",
      ...
      },
      {
        ...
        keahlian: ["js"],
        tautan:
          "https://certified.niomic.com/?number=00018210004/NIOMIC/IX/2022",
      ...
      },
      {
        ...
        keahlian: ["git", "github"],
        tautan:
          "https://certified.niomic.com/?number=00018110003/NIOMIC/IX/2022",
      ...
      },
      {
        ...
        tautan:
          "https://certified.niomic.com/?number=00018010002/NIOMIC/IX/2022",
      ...
      },
      {
        ...
        keahlian: ["html5"],
        tautan:
          "https://certified.niomic.com/?number=00017910001/NIOMIC/IX/2022",
...
export const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case "pagePosition/certification": {
      return { ...state, pagePosition: action.payload };
    }
